...
function render(variables = {}) {
  ...
  else if (variables.country == "Italy") variables.country = "Italy";
  ...
  else if (variables.city == "Rome") variables.city = "Rome";
  else if (variables.city == "Oporto") variables.city = "Oporto";
  else if (variables.city == "Paris") variables.city = "Paris";
